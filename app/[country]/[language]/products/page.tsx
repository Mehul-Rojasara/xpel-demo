...
export default async function ProductsPage({ params }: PageProps) {
  ...
  const productCards = [
    {
      ...
      description: 'A virtually invisible urethane film that protects your vehicle&apos;s paint from unsightly damage and maximizes re-sale value.',
    ...
    },
    {
      ...
      description: 'Unrivaled gloss, superior hydrophobic protection, and improved scratch resistance with a single application.',
    ...
    {
      title: 'Window Film',
      description: 'Enhance privacy, reduce infra-red heat, cut glare, and keep your skin & eyes safe from harmful UV rays.',
    ...
    },
    {
      ...
      description: 'Give your vehicle the clarity and protection it deserves. Offering clear and tinted headlight protection film options.',
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Service Card Grid */}
      <ServiceCardGrid cards={productCards} />
