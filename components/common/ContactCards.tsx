...
export const ContactCards: React.FC<ContactCardsProps> = ({
  ...
  return (
    <div 
      className={`flex flex-nowrap justify-start gap-8 ${className}`}
      role="region" 
    ...
    >
      {cards.map((card) => (
        ...
        >
          ...
          <div className="bg-white rounded-2xl transition-all duration-300 group-hover:shadow-lg group-focus:shadow-lg relative overflow-hidden flex-shrink-0 w-[320px] h-[190px] p-8">
            ...
            <div className="relative z-10 mb-6 flex justify-center">
              <div className="text-neutral-900 transition-transform duration-300 group-hover:scale-110 w-10 h-10">
                {card.icon}
              </div>
            </div>
            ...
            <div className="relative z-10 text-center">
              ...
              <h3 className="font-medium text-lg leading-tight tracking-[-0.01em] text-neutral-900 mb-3">
                {card.heading}
              </h3>
